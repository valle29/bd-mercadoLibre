<template>
  <div id="app" class="flyout">
    <mdb-navbar id="main-navbar" dark position="top" color="yellow accent-2" scrolling :scrollingOffset="20">
      <mdb-navbar-brand to="/" waves class="font-weight-bold text-color-black">
        <strong class="text-color-black">DadaSell</strong>
      </mdb-navbar-brand>
      <mdb-navbar-toggler>
...
<script>
import { mdbNavbar, mdbNavItem, mdbNavbarNav, mdbNavbarToggler, mdbNavbarBrand, mdbFooter, mdbBtn } from 'mdbvue';
